                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group col-md-6">
                                ...
                                <input value="${user.id}" readonly name="id" type="text" class="form-control" id="id">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="userName">Nazwa</label>
                                <input value="${user.userName}" readonly name="userName" type="text" class="form-control" id="userName"">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="userEmail">Email</label>
                                <input value="${user.email}" readonly name="userEmail" type="email" class="form-control" id="userEmail">
                            </div>
                            <div class="form-group col-md-6">
